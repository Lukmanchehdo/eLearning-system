...
--
-- โฮสต์: localhost
-- เวลาในการสร้าง: 23 พ.ย. 2020  15:40น.
-- เวอร์ชั่นของเซิร์ฟเวอร์: 5.5.62-0ubuntu0.14.04.1
...
('2020-11-23', '10.10.2.20');

-- --------------------------------------------------------

--
-- โครงสร้างตาราง `daily`
--
...
--
-- โครงสร้างตาราง `tbl_img_learning`
--

CREATE TABLE IF NOT EXISTS `tbl_img_learning` (
  `img_learning_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `img_learning_name` varchar(255) NOT NULL,
  `learning_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`img_learning_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=20 ;

--
-- dump ตาราง `tbl_img_learning`
--

INSERT INTO `tbl_img_learning` (`img_learning_id`, `img_learning_name`, `learning_id`, `created_at`, `updated_at`) VALUES
(9, '20201105_201827รูปภาพ4.png', 1, '2020-11-05 13:18:27', '2020-11-05 13:18:27'),
(11, '20201105_201827รูปภาพ2.png', 1, '2020-11-05 13:18:27', '2020-11-05 13:18:27'),
(12, '20201105_202613รูปภาพ1.jpg', 1, '2020-11-05 13:26:13', '2020-11-05 13:26:13'),
(13, '20201105_202706รูปภาพ3.png', 1, '2020-11-05 13:27:06', '2020-11-05 13:27:06'),
...
--
-- โครงสร้างตาราง `tbl_learning`
--

CREATE TABLE IF NOT EXISTS `tbl_learning` (
  `learning_id` int(20) NOT NULL AUTO_INCREMENT,
...
(1, 'ศูนย์การเรียนรู้ภูมิปัญญาและวัฒนธรรมท่าสาป', 'เทศบาลตำบลท่าสาป', '<div style="text-align: justify;">&nbsp; &nbsp; &nbsp; &nbsp;เป็นแหล่งเรียนรู้ที่สามารถถ่ายทอดภูมิปัญญาและวัฒนธรรมของตำบลท่าสาป ให้ผู้มาเยี่ยมเยือนได้รู้ถึงประวัติของตำบลท่าสาป และมีจุดจำหน่ายสินค้า OTOP ของชุมชน</div>', '<div style="text-align: justify;">&nbsp; &nbsp; &nbsp; &nbsp;สถานที่ท่องเที่ยวบรรยากาศดี ตั้งอยู่ริมแม่น้ำปัตตานี ผู้ที่มาเยี่ยมเยือนสามารถเรียนรู้ภูมิปัญญาและวัฒนธรรมผ่านกิจกรรมและนิทรรศการต่าง ๆ ที่จัดขึ้นเป็นประจำ หมุนเวียนกันไปภายในศูนย์เรียนรู้แห่งนี้ เช่น การสาธิตการทำอาหารและขนมพื้นบ้าน การจัดแสดงนิทรรศการภาพถ่ายวิถีชีวิตของคนในพื้นที่ การจัดแสดงวัตถุโบราณที่อายุร่วมร้อยปี เป็นต้น สถานที่แห่งนี้ยังเป็นแหล่งศึกษาดูงานชุมชน มีการจัดกิจกรรมเสวนาแลกเปลี่ยนความคิดเห็นในประเด็นต่าง ๆ นอกจากนั้นยังเป็นศูนย์จำหน่ายสินค้าในชุมชนที่รวบรวมสินค้า OTOP ขึ้นชื่อของตำบลท่าสาปเพื่อเป็นของฝากติดไม้ติดมือแก่ผู้ที่มาเยือน</div>', 'ถนนริมแม่น้ำปัตตานี หมู่ที่ 1 บ้านท่าสาป ตำบลท่าสาป อำเภอเมืองยะลา จังหวัดยะลา 95000', 'ภาพถ่าย , วารสาร', '-', 15, 3, 175, 1, '2020-10-29 08:27:22', '2020-11-02 10:16:05'),
(2, 'การแปรรูปปลาสดเป็นปลาตากแห้ง เพื่อให้เก็บไว้ได้นาน', 'นางสาวสมสุข จิงใจ', '<div style="text-align: justify;">       การแปรรูปอาหาร คนไทยในภาคต่างๆ จะรู้จักวิธีการแปรรูปอาหารในรูปแบบต่างๆ เช่น การหมักและการดอง เพื่อเก็บอาหารไว้รับประทานได้นานๆ เช่น ชุมชนที่อยู่ริมทะเล คนส่วนใหญ่จะประกอบอาชีพประมง เมื่อจับปลามาได้มากจึงนำไปแปรรูปตากแห้ง เช่น ปลาเค็ม หมึกแห้ง กุ้งแห้ง คนในภาคตะวันออกเฉียงเหนือจะนำปลาที่จับได้มาหมักในไห เรียกว่า ปลาร้า</div>', '<div style="text-align: justify;">       การแปรรูปอาหาร คนไทยในภาคต่างๆ จะรู้จักวิธีการแปรรูปอาหารในรูปแบบต่างๆ เช่น การหมักและการดอง เพื่อเก็บอาหารไว้รับประทานได้นานๆ เช่น ชุมชนที่อยู่ริมทะเล คนส่วนใหญ่จะประกอบอาชีพประมง เมื่อจับปลามาได้มากจึงนำไปแปรรูปตากแห้ง เช่น ปลาเค็ม หมึกแห้ง กุ้งแห้ง คนในภาคตะวันออกเฉียงเหนือจะนำปลาที่จับได้มาหมักในไห เรียกว่า ปลาร้า</div>', 'จือนือแร', 'ภาพ', '', 2, 4, 77, 2, '2020-11-06 04:14:11', '2020-11-23 07:16:12'),
(3, 'ศูนย์เรียนรู้เกษตรทฤษฎีใหม่ (เกษตรปลอดภัย)', 'นายฟาริด  เบ็ญมุสา', '<p><span style="font-family: THK2DJuly8, Arial, sans-serif; font-size: 19px;">&nbsp; &nbsp; มีการถ่ายทอดความรู้จากการศึกษาดูงานในศูนย์เรียนรู้เกษตรทฤษฎีใหม่ จำนวน.๒๕๐...คนต่อปี&nbsp; มีครัวเรือนที่ทำเกษตรปลอดภัยจำนวน..๓๐..ครัวเรือน&nbsp; และมีพื้นที่เกษตรอินทรีย์..๒..ไร่&nbsp;</span><br></p>', '<p style="box-sizing: inherit; font-family: THK2DJuly8, Arial, sans-serif; font-size: 19px;">จากสถานการณ์ภาระหนี้สิน และการใช้สารเคมีในการทำการเกษตรในพื้นที่ ทำให้เกษตรกรได้รับผลกระทบด้านสุขภาพเนื่องจากการใช้สารเคมีในการเกษตรทำให้ผู้นำชุมชนเล็งเห็นถึงความสำคัญในการปลูกผักปลอดสารพิษเพื่อให้เกษตรกรมีการปลูกผักตามหลักเศรษฐกิจพอเพียงและเพื่อสร้างรายได้เพิ่มให้แก่ครัวเรือนของคนในชุมชนเป็นแหล่งอาหารในครัวเรือนเพื่อลดรายจ่าย เพิ่มรายได้</p><p style="box-sizing: inherit; font-family: THK2DJuly8, Arial, sans-serif; font-size: 19px;">ในปี พ.ศ. ๒๕๖๐ นายฟาริด&nbsp; เบ็ญมุสา ซึ่งเป็นสมาชิกสภาเทศบาลตำบลปริก ได้มีแนวคิดในการจัดทำการเกษตรทฤษฎีใหม่ ปลูกพืชปลอดสารพิษ ในบริเวณบ้านของตนเอง เพื่อบริโภคภายในครัวเรือนและจำหน่ายในชุมชน ต่อมาเทศบาลตำบลปริกได้ให้เป็นศูนย์เรียนรู้ในการถ่ายทอดความรู้ในการปลูกพืชปลอดสารพิษ เช่น การทำน้ำหมัก ปุ๋ยอินทรีย์ ฮอร์โมนพืชจากวัสดุเหลือใช้ในครัวเรือน ลดการใช้สารเคมี เป็นต้น</p>', 'เทศบาลตำบลปริก (ทต.ปริก) 53 หมู่ที่ 3 ถ.รวมประชา ต.ปริก อ.สะเดา จ.สงขลา 90120', 'รูปภาพ', '', 2, 1, 3, 2, '2020-11-23 05:39:47', '2020-11-23 05:39:47');

-- --------------------------------------------------------

--
-- โครงสร้างตาราง `tbl_learning_type`
--

CREATE TABLE IF NOT EXISTS `tbl_learning_type` (
  `learning_type_id` int(20) NOT NULL AUTO_INCREMENT,
  `learning_type_name` varchar(255) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`learning_type_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=23 ;

--
-- dump ตาราง `tbl_learning_type`
--
...
(2, '111112', '11113', 'โรงเรียนทดสอบ', 'Test School', 'test', '0000001', '000000', '0000000', 'Test@gmail.com', 'https://test .yru.ac.th/', 74, 965, 8590, '94180', '6.549152217757623', '101.28897548465578', '2020-10-29 05:15:41', '2020-10-29 05:15:41');
...
(2, 'school01', '34ce9d8e82fc486d2cdf66eb95f387ab', 2, 'Member', '2020-10-28 13:01:27', '2020-10-29 05:16:18');

-- --------------------------------------------------------

--
-- โครงสร้างตาราง `tbl_vdo_learning`
--

CREATE TABLE IF NOT EXISTS `tbl_vdo_learning` (
  `vdo_learning_id` int(11) NOT NULL AUTO_INCREMENT,
  `youtube_link` varchar(255) NOT NULL,
  `learning_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`vdo_learning_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10 ;

--
-- dump ตาราง `tbl_vdo_learning`
--
...
('rtk2vpkup78n9si36h6scucmt5', '1606120782', '327'),
('j4ln0kok6cb95v5rrmmrpng960', '1606120707', '327');
