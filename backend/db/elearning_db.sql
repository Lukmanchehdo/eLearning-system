...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2020 at 02:18 AM
...
(1, 'CC – BY ให้เผยแพร่ ดัดแปลง โดยต้องระบุที่มา', '20201023_214855by.png', '2020-10-23 14:48:55', '2020-10-23 14:48:55'),
...
CREATE TABLE `tbl_learning_type` (
  `learning_type_id` bigint(20) NOT NULL,
...
(2, 'แหล่งทางการศึกษา', '2020-10-24 05:30:03', '2020-10-24 05:30:03');
...
(2, '1111112', '1112', 'มหาวิทยาลัยราชภัฏยะลา', 'Yala Rajabhat University', 'ผู้ช่วยศาสตราจารย์ ดร.สมบัติ โยธาทิพย์', '0000001', '000001', '0000001', 'chehdo@gmail.com', 'aaaaaa2', 74, 965, 8590, '94180', '6.549322758907945', '101.28908277301637', '2020-10-22 16:17:12', '2020-10-22 16:17:12');
...
INSERT INTO `tbl_user` (`user_id`, `user_name`, `password`, `school_id`, `created_at`, `updated_at`) VALUES
(1, 'school28', '2416d84fd2384fef58e629ed33f859af', 2, '2020-10-22 17:29:13', '2020-10-22 17:29:13');
...
--
ALTER TABLE `tbl_learning_type`
  MODIFY `learning_type_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_school`
--
ALTER TABLE `tbl_school`
  MODIFY `school_id` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
