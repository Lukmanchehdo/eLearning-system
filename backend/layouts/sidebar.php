  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="?menu=home" class="brand-link">
          <img src="dist/img/PTSLogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="sidebar">
          ...
          <nav class="mt-2">
           ...
           with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item has-treeview <?php if (($_GET["menu"] == "student") OR ($_GET["menu"] == "personality")){ echo "menu-open"; } ?>">
                      <a href="#" class="nav-link <?php if (($_GET["menu"] == "student") OR ($_GET["menu"] == "personality")){ echo "active"; } ?>">
