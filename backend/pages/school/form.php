<div class="content-wrapper">
  ...
  if (!empty($_GET["school_id"])) {
    ...
    $sql = "SELECT * FROM tbl_school INNER JOIN amphur ON tbl_school.amphur = amphur.AMPHUR_ID INNER JOIN district ON tbl_school.district = district.DISTRICT_ID INNER JOIN province ON tbl_school.province = province.PROVINCE_ID WHERE tbl_school.school_id ='" . decrypt(urldecode(@$_GET['school_id'])) . "'";
  ...
  <section class="content">
    ...
    if (@$_GET["Action"] == "edit") {
      ...
      if (($_POST["school_name_th"] != "") AND ($_GET["school_id"] != "")) {
        ...
        if ($result==true) { 
          ...
          <META HTTP-EQUIV="Refresh" CONTENT="3;URL=?menu=school-view&school_id=<?php echo urlencode(encrypt(@$_GET['school_id'])); ?>">
    ...
    if (!empty($_GET["school_id"])) {
      ?>
      <form method="POST" action="?menu=school-edit&Action=edit&school_id=<?php echo decrypt(urldecode(@$_GET['school_id'])); ?>">
      <?php } else { ?>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" id="school_director" name="school_director" value="<?php echo @$row['school_director']; ?>" class="form-control" required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" id="school_tell" name="school_tell" value="<?php echo @$row['school_tell']; ?>" class="form-control" required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <input type="text" id="school_lat" name="school_lat" value="<?php echo @$row['school_lat']; ?>" class="form-control" required>
              </div>
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label for="inputName">Longitude</label>
                <input type="text" id="school_lng" name="school_lng" value="<?php echo @$row['school_lng']; ?>" class="form-control" required>
              </div>
            </div>
          </div>
          <div class="form-group">
