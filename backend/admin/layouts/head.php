<head>
	...
	if (($_GET["menu"] == "learning") OR ($_GET["menu"] == "learning-add") OR ($_GET["menu"] == "learning-view") OR ($_GET["menu"] == "learning-edit") OR ($_GET["menu"] == "learning-edit_img") OR ($_GET["menu"] == "learning-edit_vdo")){ echo $title = "ข้อมูลแหล่งเรียนรู้"; } ?></title>
